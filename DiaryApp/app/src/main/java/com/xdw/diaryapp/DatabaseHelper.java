...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private final static String SQL_CREATE_DATABASE="CREATE TABLE "+Diaries.Diary.TABLE_NAME
            + " ("+Diaries.Diary._ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"
            +Diaries.Diary.COLUMN_NAME_DATE+" TEXT"+","+ Diaries.Diary.COLUMN_NAME_WEATHER
            +" TEXT"+","+Diaries.Diary.COLUMN_NAME_CONTENT+" TEXT"+" )";
